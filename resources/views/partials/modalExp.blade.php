...
<button type="button" class="btn btn-primary mx-3" data-toggle="modal" data-target="#staticBackdrop4">
    Cars above 4k
  </button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Cars above 4k</h5>
